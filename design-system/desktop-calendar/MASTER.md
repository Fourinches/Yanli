...
**Generated:** 2026-08-17 09:37:17
**Category:** Desktop calendar widget · Chinese ink / paper
...
|------|-----|--------------|
| Primary | `#44403C` | `--color-primary` |
| On Primary | `#FFFBEB` | `--color-on-primary` |
| Secondary | `#78716C` | `--color-secondary` |
| Accent/CTA | `#9F1239` | `--color-accent` |
| Background | `#FFFBEB` | `--color-background` |
| Foreground | `#1C1917` | `--color-foreground` |
| Muted | `#F5F0E6` | `--color-muted` |
| Border | `#E7E0D2` | `--color-border` |
| Destructive | `#9F1239` | `--color-destructive` |
| Ring | `#44403C` | `--color-ring` |

**Color Notes:** 宣纸底 + 墨色字 + 朱红标休息日；节气用石青 `#3F6F64`。覆盖自动生成的日历蓝。
...
**Style:** Swiss grid + editorial ink/paper（覆盖自动推荐的 Organic Biophilic）

**Keywords:** 宣纸, 墨色, 网格月历, 留白, 高对比, 单点朱红

**Best For:** 桌面中国日历小组件

**Key Effects:** 12–16px 圆角纸卡、轻阴影、无装饰插画、节气/休班用文字而非 emoji
